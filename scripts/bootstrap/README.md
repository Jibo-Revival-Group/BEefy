...
The apply helper also patches `/usr/local/lib/libJiboServerService.so`. It accepts only an explicitly supported stock or already-patched hash pair: v1 (`ae82f1dd7407f8d74b287917cb9a8b24` -> `e55e18e92aa6365569f13214e0118745`), v2/lastdance (`a863a238d6f2531446d0eb0d1d358c19` -> `688ec2940ed1fc7d1b86d2fd29bc6b30`), or early-model (`e3f3e394815bebb37427f65ead579e0f` -> `db55f99018e2348c2754b1daa6e1df39`). For every supported build it replaces exactly two equal-length `jibo.com` byte sequences with `jibo.pro`. The resulting native token host is `open-jibo.jibo.pro`; Azure must bind that hostname directly to the API service.
