...
Provider-specific price, billing, entitlement, customer policy, and support operations belong to the provider. Transcendent Software's implementation is private and represented publicly by [api.5x1.com](https://api.5x1.com).
